...
const WINDOWhIEIGHT = Dimensions.get('window').height;
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={require("../images/background.png")} style={{
          height: WINDOWhIEIGHT,
          width: null,
          flex: 1
        }}>
          {/* 头部 */}
          <Text style={{ color: "#FFFF", fontSize: 25, fontWeight: '600', textAlign: 'center', marginTop: 30 }}>SUDUKU</Text>
          <View style={styles.header}>
            <Touchable disabled={initing} onPress={this.onShowModal}>
              <Image
                style={[styles.buttonMenuIcon, initing && styles.disabled]}
        ...
        >
          ...
          <ImageBackground source={require("../images/begin.png")} style={styles.modal}>
            ...
            >
              ...
              {/* <Image
                ...
                source={require("../images/28sudu.png")}
              /> */}
              ...
              >
                <Image
                  style={[styles.functionImg, disabled && styles.disabled]}
                  source={require("../images/resume_game.png")}
                />
              </Touchable>
              ...
              >
                <Image
                  style={[styles.functionImg, disabled && styles.disabled]}
                  source={require("../images/reload_game.png")}
                />
              </Touchable>
              ...
              <Touchable style={styles.button} onPress={this.onCreate}>
                <Image
                  ...
                  source={require("../images/new_game.png")}
                />
              </Touchable>
...
const styles = StyleSheet.create({
  ...
  recordText: {
    ...
    lineHeight:
      Platform.OS == "android" ? Math.floor(CellSize * 4 / 6) : CellSize * 4 / 6
  },
  highlightText: {
    color: "khaki"
  },
